$(document).ready(function(){
  ...
  function htmlInput(data, cday) {
    ...
    switch(data.weather[0].main){
      ...
      if(h > 6 && h < 20){
        $("body").css("background", "linear-gradient(rgba(0, 0, 0, 0.2),rgba(0, 0, 0, 0.2)),url('../img/lwapp/thunderstorm-day.jpg')");
      }
      else {
        $("body").css("background", "linear-gradient(rgba(0, 0, 0, 0.2),rgba(0, 0, 0, 0.2)),url('../img/lwapp/thunderstorm-night.jpg')");
      }
      ...
      if(h > 6 && h < 20){
        $("body").css("background", "linear-gradient(rgba(0, 0, 0, 0.2),rgba(0, 0, 0, 0.2)),url('../img/lwapp/drizzle-day.jpg')");
      }
      else {
        $("body").css("background", "linear-gradient(rgba(0, 0, 0, 0.2),rgba(0, 0, 0, 0.2)),url('../img/lwapp/drizzle-night.jpg')");
      }
      $("body").css("background-size", "100%");
      $("h1").css("color", "#3d5afe");
      break;
      ...
      weatherIcon = "wi-rain";
      if(h > 6 && h < 20){
        $("body").css("background", "linear-gradient(rgba(0, 0, 0, 0.2),rgba(0, 0, 0, 0.2)),url('../img/lwapp/rain-day.jpg')");
      }
      else {
        $("body").css("background", "linear-gradient(rgba(0, 0, 0, 0.2),rgba(0, 0, 0, 0.2)),url('../img/lwapp/rain-night.jpg')");
      }
      $("body").css("background-size", "100%");
      $("h1").css("color", "#3d5afe");
      break;
      ...
      weatherIcon = "wi-snow";
      if(h > 6 && h < 20){
        $("body").css("background", "linear-gradient(rgba(0, 0, 0, 0.2),rgba(0, 0, 0, 0.2)),url('../img/lwapp/snow-day.jpg')");
      }
      else {
        $("body").css("background", "linear-gradient(rgba(0, 0, 0, 0.2),rgba(0, 0, 0, 0.2)),url('../img/lwapp/snow-night.jpg')");
      }
      $("body").css("background-size", "100%");
      $("h1").css("color", "#3d5afe");
      break;
      ...
      if(h > 6 && h < 20){
        $("body").css("background", "linear-gradient(rgba(0, 0, 0, 0.2),rgba(0, 0, 0, 0.2)),url('../img/lwapp/clear-day.jpg')");
      }
      else {
        $("body").css("background", "linear-gradient(rgba(0, 0, 0, 0.2),rgba(0, 0, 0, 0.2)),url('../img/lwapp/clear-night.jpg')");
      }
      $("body").css("background-size", "100%");
      $("h1").css("color", "#3d5afe");
      break;
      ...
      if(h > 6 && h < 20){
        $("body").css("background", "linear-gradient(rgba(0, 0, 0, 0.2),rgba(0, 0, 0, 0.2)),url('../img/lwapp/clouds-day.jpg')");
      }
      else {
        $("body").css("background", "linear-gradient(rgba(0, 0, 0, 0.2),rgba(0, 0, 0, 0.2)),url('../img/lwapp/clouds-night.jpg')");
      }
      $("body").css("background-size", "100%");
      $("h1").css("color", "#3d5afe");
      break;
      ...
      $("body").css("background", "linear-gradient(rgba(0, 0, 0, 0.2),rgba(0, 0, 0, 0.2)),url('../img/lwapp/mist.jpg')");
      $("body").css("background-size", "100%");
      $("h1").css("color", "#3d5afe");
      break;
      case "Sand":
